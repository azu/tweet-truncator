...
describe("example-test", function () {
    it("should", () => {
        ...
        assert.strictEqual(result, "core-js 2.0.0リリース。 Typed Arrayの実装追加、`System.global`、`Error.isError`、MathのProposal実装を追加。 Promiseの仕様追従、`String#{padStart, padEnd}`へリネーム。 NodeListなどをIterableとする再定義の追加するなど \"Release 2.0.0 - 2015.12.24…\" https://github.com/zloirock/core-js/releases/tag/v2.0.0");
